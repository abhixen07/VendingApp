...
class ChocolateCategoryPage extends ConsumerStatefulWidget {
  final String title;
  ...
  @override
  ConsumerState<ChocolateCategoryPage> createState() => _CategoriespageState();
}

class _CategoriespageState extends ConsumerState<ChocolateCategoryPage> {
